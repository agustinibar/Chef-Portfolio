...
export const Main = () => {
  return (
    <section>
      ...
      <p className='absolute top-[144px] w-[327px] font-Fraunces font-black text-[40px] uppercase tracking-[6.25px] text-White text-center left-0 right-0 mx-auto sm:w-[600px] xl:text-[56px] xl:w-[750px] xl:top-[191px] xl:tracking-[8.75px]'>I love being creative</p>
